    ...
    <div className="min-h-screen bg-black text-white antialiased overflow-x-hidden relative">
        ...
        <div className="max-w-7xl mx-auto px-6 py-4">
          <nav className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div className="text-xl font-bold">BLACKHOUSING</div>
            </div>
            ...
            <div className="hidden md:flex items-center gap-8">
              ...
              <a 
                ...
                target="_blank" 
                rel="noreferrer" 
                className="inline-flex items-center gap-2 px-5 py-2.5 bg-white text-black rounded-lg hover:bg-gray-200 transition-colors duration-200"
              >
      ...
      >
        ...
        >
          ...
          <motion.div className="mb-8 max-w-6xl">
            <motion.h1
              className="text-5xl md:text-8xl font-thin tracking-wider mb-4"
            ...
            <motion.div
              className="h-0.5 w-32 bg-gradient-to-r from-transparent via-white to-transparent mx-auto mb-6"
              initial={{ scaleX: 0 }}
      ...
      <main className="max-w-7xl mx-auto px-6 py-20">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <section className="space-y-8">
            <div className={`transform transition-all duration-1000 ${isLoaded ? 'translate-y-0 opacity-100' : 'translate-y-8 opacity-0'}`}>
              ...
              <div className="inline-flex items-center gap-2 px-4 py-2 bg-gray-800 rounded-full mb-8">
                ...
                <span className="text-sm font-semibold text-gray-100">UNILAG's #1 Trusted Housing Platform</span>
              </div>
              ...
              <div className="space-y-6 mb-12">
                <form onSubmit={submitWaitlist} className="flex gap-3 max-w-lg">
                  <div className="flex-1">
                    <input 
                      ...
                      className="w-full px-6 py-4 rounded-lg border border-gray-700 bg-gray-800 placeholder-gray-400 text-white focus:outline-none focus:border-emerald-500 transition-colors duration-200"
                  ...
                  <button 
                    type="submit" 
                    disabled={status.wait === 'loading'}
                    className="px-8 py-4 rounded-lg bg-white text-black font-bold flex items-center gap-3 hover:bg-gray-200 transition-colors duration-200 disabled:opacity-70 disabled:cursor-not-allowed"
                  >
                    {status.wait === 'loading' ? (
                ...
                {status.wait === 'success' && (
                  <div className="flex items-center gap-3 text-green-400 bg-green-900/20 px-4 py-3 rounded-lg border border-green-500/20">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="p-4 bg-gray-800 rounded-lg border border-gray-700 hover:border-gray-600 transition-colors duration-200">
                  <div className="flex items-center gap-3">
                    <div className="w-10 h-10 bg-white rounded-lg flex items-center justify-center">
                      <Shield className="w-6 h-6 text-black" />
                    </div>
                    <div>
                      <div className="font-bold text-white text-lg">100% Scam-Free</div>
                      <div className="text-sm text-gray-400">Verified listings only</div>
                    </div>
                  </div>
                </div>
                <div className="p-4 bg-gray-800 rounded-lg border border-gray-700 hover:border-gray-600 transition-colors duration-200">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <div className="font-bold text-white text-lg">Lightning Fast</div>
                      <div className="text-sm text-gray-400">Find homes in minutes</div>
                    </div>
                  </div>
                </div>
              </div>
          ...
          {/* Visual Section with Property Cards */}
          <section className={`transform transition-all duration-1000 ${isLoaded ? 'translate-y-0 opacity-100' : 'translate-y-8 opacity-0'}`}>
            <div className="relative">
              {/* Main Container */}
              <div className="relative bg-gray-800 rounded-2xl p-8 border border-gray-700 shadow-lg">                  
                <div className="relative grid grid-cols-1 gap-6">
                  {/* Premium Property Card 1 */}
                  <div className="group bg-gray-700 rounded-lg p-6 border border-gray-600 hover:border-emerald-500 transition-colors duration-200">
                    <div className="flex items-start justify-between mb-4">
                      ...
                      <div className="flex items-center gap-2">
                        <div className="bg-emerald-500/20 text-emerald-300 px-3 py-1 rounded-full text-xs font-bold border border-emerald-400/30">
                          VERIFIED
                        </div>
                        <div className="bg-amber-500/20 text-amber-300 px-3 py-1 rounded-full text-xs font-bold border border-amber-400/30">
                          PREMIUM
                        </div>
                      </div>
                    </div>
                    <h3 className="font-bold text-xl mb-2 text-white group-hover:text-emerald-300 transition-colors duration-300">Private Room Near Faculty of Science</h3>
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-sm text-gray-400 font-medium">(4.9) 127 reviews</span>
                    </div>
                  </div>

                  {/* Premium Property Card 2 */}
                  <div className="group bg-gray-700 rounded-2xl p-6 border border-gray-600 hover:border-teal-500 hover:scale-105 transition-all duration-500 shadow-lg">
                    <div className="flex items-start justify-between mb-4">
                      <div className="relative">
                      ...
                      <div className="flex items-center gap-2">
                        <div className="bg-teal-500/20 text-teal-300 px-3 py-1 rounded-full text-xs font-bold border border-teal-400/30">
                          POPULAR
                        </div>
                        <div className="bg-rose-500/20 text-rose-300 px-3 py-1 rounded-full text-xs font-bold border border-rose-400/30">
                          HOT
                        </div>
                      </div>
                    </div>
                    <h3 className="font-bold text-xl mb-2 text-white group-hover:text-teal-300 transition-colors duration-300">Bedspace at Akoka</h3>
                    <div className="flex items-center gap-4 text-gray-400 text-sm mb-4">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-sm text-gray-400 font-medium">(4.2) 89 reviews</span>
                    </div>
                  </div>

                  {/* Enhanced Features Grid */}
                  <div className="grid grid-cols-3 gap-3 mt-4">
                    <div className="group bg-gray-700 rounded-xl p-3 text-center border border-gray-600 hover:border-emerald-500 transition-colors duration-300">
                    ...
                    <div className="group bg-gray-700 rounded-xl p-3 text-center border border-gray-600 hover:border-teal-500 transition-colors duration-300">
                    ...
                    <div className="group bg-gray-700 rounded-xl p-3 text-center border border-gray-600 hover:border-amber-500 transition-colors duration-300">
      ...
      <section className="max-w-7xl mx-auto px-6 py-20">
        <div className="relative bg-gradient-to-br from-gray-800/30 to-gray-900/30 rounded-3xl p-12 backdrop-blur-xl border border-gray-700/40 shadow-2xl overflow-hidden">
          ...
          <div className="relative text-center mb-12">
            <h2 className="text-4xl md:text-5xl font-black bg-gradient-to-r from-white via-emerald-200 to-teal-200 bg-clip-text text-transparent mb-4">
              Trusted by Thousands
            </h2>
            <p className="text-xl text-gray-400 font-light">Join the fastest-growing student housing community in UNILAG</p>
          </div>
              ...
              return (
                <div key={index} className="group text-center">
                  <div className="relative w-20 h-20 mx-auto mb-4">
                    <div className="w-20 h-20 bg-gradient-to-br from-emerald-500/10 to-teal-500/10 rounded-2xl flex items-center justify-center border border-emerald-500/20 group-hover:scale-110 group-hover:border-emerald-400/40 transition-all duration-500">
                      <IconComponent className="w-10 h-10 text-emerald-400 group-hover:text-emerald-300 transition-colors duration-300" />
                    </div>
                  </div>
                  <div className="text-4xl md:text-5xl font-black text-white mb-2 group-hover:text-emerald-400 transition-colors duration-500">
      ...
      <section id="features" className="max-w-7xl mx-auto px-6 py-20">
        <div className="text-center mb-16">
          <div className="inline-flex items-center gap-3 px-5 py-2.5 bg-gradient-to-r from-emerald-500/10 to-teal-500/10 rounded-full border border-emerald-500/20 mb-8">
            <Sparkles className="w-4 h-4 text-emerald-400" />
            <span className="text-sm font-semibold text-emerald-300">Why Choose BLACKHOUSING</span>
          </div>
          <h2 className="text-5xl md:text-6xl font-black bg-gradient-to-r from-white via-emerald-200 to-teal-200 bg-clip-text text-transparent mb-6">
            Premium Features
          </h2>
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {[
            ...
            return (
              <div
                key={index}
                className={`group relative bg-gradient-to-br ${feature.bgGradient} bg-gray-800 rounded-3xl p-8 border ${feature.borderColor} ${feature.hoverBorder} transition-all duration-500 hover:scale-105 hover:-translate-y-2 shadow-lg hover:shadow-2xl overflow-hidden`}
              >
                <div className="absolute inset-0 bg-gradient-to-br from-gray-800/20 to-gray-900/20 opacity-0 group-hover:opacity-100 transition-opacity duration-500 rounded-3xl"></div>
                ...
                <div className="relative">
                  ...
                  <h3 className="text-2xl font-black text-white mb-6 text-center group-hover:text-emerald-300 transition-colors duration-500">
                    {feature.title}
                  </h3>
                  <p className="text-gray-400 text-center leading-relaxed mb-6 group-hover:text-gray-300 transition-colors duration-300">
                    {feature.description}
                  </p>
                  ...
                  <div className="space-y-3">
                    {feature.features.map((item, idx) => (
                      <div key={idx} className="flex items-center gap-3">
                        ...
                        <span className="text-gray-300 text-sm font-medium group-hover:text-gray-200 transition-colors duration-300">{item}</span>
                      </div>
                    ))}
                  </div>
                </div>
      ...
      <section id="how" className="max-w-7xl mx-auto px-6 py-20">
        <div className="text-center mb-16">
          ...
          <p className="text-2xl text-gray-400 font-light">Simple steps to find your perfect home</p>
        </div>
          ...
          {[
            ...
            return (
              <div key={index} className="relative group text-center">
                ...
                <div className="text-8xl font-black text-gray-800 mb-4 group-hover:text-gray-700 transition-colors duration-300">{step.step}</div>
                <h3 className={`text-2xl font-bold text-white mb-4 group-hover:${colors.text} transition-colors duration-300`}>{step.title}</h3>
      ...
      <section id="testimonials" className="max-w-7xl mx-auto px-6 py-20">
        <div className="text-center mb-16">
          ...
          <p className="text-2xl text-gray-400 font-light">Hear from students who found their perfect home</p>
        </div>
            ...
            >
              {testimonials.map((testimonial, index) => (
                <div key={index} className="w-full flex-shrink-0 p-12">
                  <div className="relative bg-gradient-to-br from-gray-800/40 to-gray-900/40 rounded-3xl p-12 border border-gray-700/40 text-center shadow-2xl overflow-hidden">
                    ...
                    <div className="relative">
                      ...
                      <p className="text-2xl text-gray-300 mb-8 italic leading-relaxed font-light">
                        "{testimonial.text}"
                      </p>
      ...
      <section id="contact" className="max-w-6xl mx-auto px-6 py-20">
        <div className="relative bg-gradient-to-br from-gray-800/40 to-gray-900/40 rounded-3xl p-12 border border-gray-700/40 shadow-2xl overflow-hidden">
          <div className="absolute inset-0 bg-gradient-to-br from-emerald-500/5 via-transparent to-teal-500/5 opacity-60"></div>
          <div className="absolute inset-0 bg-gradient-to-tl from-amber-500/5 via-transparent to-orange-500/5 opacity-60"></div>
            ...
            <div className="space-y-8">
              <div className="space-y-6">
                {[
                  ...
                  return (
                    <div key={idx} className="group flex items-center gap-4 p-4 bg-gray-800/30 rounded-2xl border border-gray-600/30 hover:border-emerald-500/30 transition-all duration-300">
                      ...
                      <div>
                        <div className="font-semibold text-white group-hover:text-emerald-300 transition-colors duration-300">{contact.title}</div>
                        <div className="text-gray-400 group-hover:text-gray-300 transition-colors duration-300">{contact.detail}</div>
                      </div>
                    </div>
                  );
                })}
            ...
            <form onSubmit={submitContact} className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <input 
                  ...
                  className="px-6 py-4 rounded-2xl bg-gray-800/30 border border-gray-600/30 placeholder-gray-400 outline-none focus:border-emerald-500/50 focus:ring-2 focus:ring-emerald-500/20 transition-all duration-300 text-white hover:border-gray-500/40"
                />
                <input 
                  value={contact.email} 
              ...
              <textarea 
                ...
                required
                rows={6}
                className="w-full px-6 py-4 rounded-2xl bg-gray-800/30 border border-gray-600/30 placeholder-gray-400 outline-none focus:border-emerald-500/50 focus:ring-2 focus:ring-emerald-500/20 transition-all duration-300 text-white resize-none hover:border-gray-500/40"
              />
              ...
              {status.contact === 'success' && (
                <div className="flex items-center gap-3 text-emerald-400 bg-emerald-500/10 px-4 py-3 rounded-xl border border-emerald-500/20">
                  <CheckCircle className="w-5 h-5" />
              ...
              {status.contact && status.contact !== 'success' && status.contact !== 'error' && status.contact !== 'loading' && (
                <div className="text-amber-400 text-sm bg-amber-500/10 px-4 py-3 rounded-xl border border-amber-500/20">
                  {status.contact}
                </div>
              )}
            </form>
      ...
      <section className="max-w-7xl mx-auto px-6 py-20">
        <div className="text-center">
          <div className="relative bg-gradient-to-br from-emerald-500/10 to-teal-500/10 rounded-3xl p-16 border border-emerald-500/20 shadow-2xl overflow-hidden">
            <div className="absolute inset-0 bg-gradient-to-br from-emerald-500/5 via-transparent to-teal-500/5 opacity-60"></div>
            ...
            <div className="relative z-10">
              ...
              <h2 className="text-5xl md:text-7xl font-black bg-gradient-to-r from-white via-emerald-200 to-teal-200 bg-clip-text text-transparent mb-8 leading-tight">
                Ready to Find Your Perfect Home?
              </h2>
              <p className="text-2xl text-gray-400 mb-12 max-w-4xl mx-auto font-light leading-relaxed">
              ...
              <div className="flex flex-col sm:flex-row gap-6 justify-center items-center mb-12">
                ...
                <div className="inline-flex items-center gap-4 px-12 py-6 bg-gray-800/30 rounded-full border border-gray-600/30 font-bold text-lg hover:border-emerald-500/30 transition-colors duration-300">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
                {[
                  ...
                  <div key={idx} className="flex items-center justify-center space-x-3 text-gray-300 hover:text-gray-100 transition-colors duration-300">
            ...
            <ul className="space-y-4">
              {[
                ...
                <li key={idx}>
                  <a 
                    href={link.href} 
                    className="text-gray-400 hover:text-emerald-400 transition-all duration-300 hover:translate-x-2 transform inline-block font-medium"
                  >
                    {link.text}
                  </a>
                </li>
